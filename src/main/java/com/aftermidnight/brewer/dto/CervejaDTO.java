...
public class CervejaDTO {
	...
	private String foto;
	private String urlFotoThumbnail;
	...
	public String getUrlFotoThumbnail() {
		return urlFotoThumbnail;
	}


	public void setUrlFotoThumbnail(String urlFotoThumbnail) {
		this.urlFotoThumbnail = urlFotoThumbnail;
	}
