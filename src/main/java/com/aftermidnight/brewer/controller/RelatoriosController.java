...
import com.aftermidnight.brewer.dto.PeriodoRelatorio;
...
public class RelatoriosController {
	...
	public ModelAndView relatorioVendasEmitidas(){
		ModelAndView mv = new ModelAndView("relatorios/RelatorioVendasEmitidas");
	...
	public ModelAndView gerarRelatorioVendasEmitidas(PeriodoRelatorio periodoRelatorio){
		...
		parametros.put("Param_data_inicio", dataInicio);
		parametros.put("Param_data_fim", dataFim);
